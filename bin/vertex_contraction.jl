...
for user_conf in angular_spins
    ...
    for Dl = Dl_min:Dl_max
        ...
        @time @sync @distributed for current_angular_spins_comb in eachindex(spins_map)
            ...
            SpinfoamFinalContraction!(contracted_spinfoam, coherent_matrix_up, coherent_matrix_down, i1_range, total_radial_spins_combinations, path_contracted_spinfoam)
