# The following code is taken from the src folder of the julia package "WignerD"
# https://github.com/jishnub/WignerD.jl
...
function wignerdjmn(j, m, n, β::Real, λ, v)
    ...
    jr = _indrange(j)
    @turbo warn_check_args=false for μind in eachindex(jr)
        μ = jr[μind]
